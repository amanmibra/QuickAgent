...
async def get_transcript(callback):
    ...
    try:
        ...
        # TODO: Read DeepGram streaming guide
...
FILLER_WORDS = ["Well", "Okay", "I mean", "You know"]
...
class ConversationManager:
    ...
    async def main(self):
        def handle_full_sentence(full_sentence):
            ...
            self.transcription_history.append(full_sentence)
        ...
        while True:
            ...
            # TODO: Consider adding transitionary filler speech here from TTS
            if self.transcription_history:
                tts.speak(random.choice(FILLER_WORDS))

            # Check for "goodbye" to exit the loop
            if "goodbye" in self.transcription_response.lower():
                # TODO: Add "Goodbye!" response back from TTS
                tts.speak("Goodbye!")
                break
